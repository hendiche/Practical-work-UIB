...
class HomeController extends Controller
{
    ...
    public function view($id) {
      $view = Accreditation::find($id);
      return view('test')->with('view', $view);
    }
    ...
    public function start(Request $request)
    {
      ...
      $akreditasi->save();
      $acc_date = Carbon::parse($akreditasi->accreditation_date)->format('d - M - Y');
      return view('standart1')->with('hasil', '')->with('value', '')
                              ->with('acc_id', $akreditasi->id)
                              ->with('prodi_name', $akreditasi->programStudy->name)
                              ->with('acc_date', $acc_date);
    }
    ...
    public function standart3(Request $request)
    {
      ...
      $insert->val311d = $val311d;
      $val311d = $val311d * 1.30;

      $arrVal['3_1_2'] = $request['3_1_2'];
      $insert->val312 = $request['3_1_2'];
      $arrVal['3_1_3'] = $request['3_1_3'];
      $insert->val313 = $request['3_1_3'];
      ...
      $insert->val314b = $val314b;
      $val314b = $val314b * 0.65;

      $arrVal['3_2_1'] = $request['3_2_1'];
      $insert->val321 = $request['3_2_1'];
      ...
      $arrVal['3_2_2'] = $val322;
      $insert->val322 = $val322;
      $val322 = $val322 * 0.65;

      $arrVal['3_3_1_a'] = $request['3_3_1a'];
      $insert->val331a = $request['3_3_1a'];
      $arrVal['3_3_1_b'] = $request['3_3_1b'];
      $insert->val331b = $request['3_3_1b'];
      ...
      $arrVal['3_3_3'] = $val333;
      $insert->val333 = $val333;
      $val333 = $val333 * 0.65;

      $arrVal['3_4_1'] = $request['3_4_1'];
      $insert->val341 = $request['3_4_1'];
      $arrVal['3_4_2'] = $request['3_4_2'];
      $insert->val342 = $request['3_4_2'];
    ...
    public function standart4(Request $request)
    {
      ...
      $arrVal['4_3_3'] = $val433;
      $insert->val433 = $val433;
      $val433 = $val433 * 0.72;

      $arrVal['4_3_4'] = $request['4_3_4'];
      $insert->val434 = $request['4_3_4'];
      ...
      $arrVal['4_4_1'] = $val441;
      $insert->val441 = $val441;
      $val441 = $val441 * 0.72;

      $arrVal['4_4_2a'] = $request['4_4_2a'];
      $insert->val442a = $request['4_4_2a'];
      ...
      $insert->val461a = $val461a;
      $val461a = $val461a * 0.72;

      $arrVal['4_6_1b'] = $request['4_6_1b'];
      $insert->val461b = $request['4_6_1b'];
    ...
    public function standart5(Request $request)
    {
      ...
      $insert->val541a = $val541a;
      $val541a = $val541a * 0.57;

      $arrVal['5_4_1b'] = $request['5_4_1b'];
      $insert->val541b = $request['5_4_1b'];
      ...
      $insert->val551c = $val551c;
      $val551c = $val551c * 0.57;

      $arrVal['5_5_1d'] = $request['5_5_1d'];
      $insert->val551d = $request['5_5_1d'];
    ...
    {
      $arrVal = [];
      $insert = new StandartSixth();

      $arrVal['6_1'] = $request['6_1'];
      $insert->val61 = $request['6_1'];
    ...
    public function standart7(Request $request)
    {
      ...
      $arrVal['7_1_3'] = $val713;
      $insert->val713 = $val713;
      $val713 = $val713 *  3.75;

      $arrVal['7_1_4'] = $request['7_1_4'];
      $insert->val714 = $request['7_1_4'];
      ...
      $akre = Accreditation::find($request->accreditation_id);
      if ($akre) {
        $st1 = StandartFirst::where('accreditation_id', '=', $akre->id)->first();
        $st2 = StandartSecond::where('accreditation_id', '=', $akre->id)->first();
        $st3 = StandartThird::where('accreditation_id', '=', $akre->id)->first();
        $st4 = StandartFourth::where('accreditation_id', '=', $akre->id)->first();
        $st5 = StandartFifth::where('accreditation_id', '=', $akre->id)->first();
        $st6 = StandartSixth::where('accreditation_id', '=', $akre->id)->first();

        $total_score = (float)$st1->score + (float)$st2->score + (float)$st3->score + (float)$st4->score + (float)$st5->score + (float)$st6->score + (float)$insert->score;
        $akre->total_score = $total_score;
        $akre->save();
      }
