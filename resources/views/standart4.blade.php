                    ...
                    <div class="panel-body">
                        {{ Form::open(['url' => route('post_standart4')]) }}
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <label>{{ Form::radio('4.1', 4) }} Ada pedoman tertulis yang lengkap dan ada bukti dilaksanakan secara konsisten</label>
                                </div>
                                <div class="radio">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <label>{{ Form::radio('4.2.1', 4) }} Ada pedoman tertulis yang lengkap dan ada bukti dilaksanakan secara konsisten</label>
                                </div>
                                <div class="radio">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <label>{{ Form::radio('4.2.2', 4) }} Ada bukti tentang kinerja dosen di bidang
                                    <ul>
                                        <li>Pendidikan</li>
                                        <li>Penelitian</li>
                            ...
                            <div class="form-group">
                                ...
                                <p>Jumlah semua dosen tetap yang bidang keahliannya sesuai PS
                                    <input type="number" name="4.3.1" class="form-control s4-inputBox" placeholder="Total Dosen" />
                                </p>
                                <p>Jumlah dosen tetap yang berpendidikan (terakhir) S2 dan S3 yang bidang keahliannya sesuai PS
                                    <input type="number" name="4.3.1a" class="form-control s4-inputBox" placeholder="Total Dosen" />
                                </p>
                                <p>Jumlah dosen tetap yang berpendidikan S3 yang bidang keahliannya sesuai PS
                                    <input type="number" name="4.3.1b" class="form-control s4-inputBox" placeholder="Total Dosen" />
                                </p>
                                <p>Jumlah dosen tetap yang memiliki jabatan lektor kepala dan guru besar yang bidang keahliannya sesuai PS
                                    <input type="number" name="4.3.1c" class="form-control s4-inputBox" placeholder="Total Dosen" />
                                </p>
                                <p>Jumlah dosen tetap yang memiliki Sertifikat Pendidik Profesional
                                    <input type="number" name="4.3.1d" class="form-control s4-inputBox" placeholder="Total Dosen" />
                                </p>
                            ...
                            <div class="form-group">
                                <label>4.3.3 &nbsp; Rata-rata beban dosen per semester, atau rata-rata FTE (<i>Fulltime Teaching Equivalent</i>)
                                    <input type="number" name="4.3.3" class="form-control s4-inputBox input-FTE" placeholder="Rata-rata sks" />
                                    sks
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="radio">
                                    <label>{{ Form::radio('4.3.4', 4) }} Semua mata kuliah diajar oleh dosen yagn sesuai keahliannya</label>
                                </div>
                                <div class="radio">
                            ...
                            <div class="form-group">
                                <p>Jumlah semua pertemuan mata kuliah yang direncanakan
                                    <input type="number" name="4.3.5ren" class="form-control s4-inputBox input-pertemuan-dosen" placeholder="Jumlah Rencana" />
                                </p>
                                <p>Jumlah semua pertemuan mata kuliah yang terlaksanakan
                                    <input type="number" name="4.3.5lak" class="form-control s4-inputBox input-pertemuan-dosen" placeholder="Jumlah terlaksana" />
                                </p>
                            ...
                            <div class="form-group">
                                <p>Jumlah seluruh dosen yang tetap maupun tidak tetap
                                    <input type="number" name="4.4.1tot" class="form-control s4-inputBox" placeholder="Total Dosen" />
                                </p>
                                <p>Jumlah dosen yang tidak tetap
                                    <input type="number" name="4.4.1tdk" class="form-control s4-inputBox" placeholder="Total Dosen" />
                                </p>
                            </div>
                            <label>4.4.2.a &nbsp; Kesesuaian keahlian dosen tidak tetap dengan mata kuliah yang diampu</label>
                            <div class="form-group">
                                <div class="radio">
                                    <label>{{ Form::radio('4.4.2a', 4) }} Semua dosen tidak tetap mengajar mata kuliah yang sesuai keahliannya</label>
                                </div>
                                <div class="radio">
                            ...
                            <div class="form-group">
                                <p>Jumlah semua pertemuan mata kuliah yang direncanakan
                                    <input type="number" name="4.4.2bren" class="form-control s4-inputBox input-pertemuan-dosen" placeholder="Jumlah Rencana" />
                                </p>
                                <p>Jumlah semua pertemuan mata kuliah yang terlaksanakan
                                    <input type="number" name="4.4.4blak" class="form-control s4-inputBox input-pertemuan-dosen" placeholder="Jumlah terlaksana" />
                                </p>
                            ...
                            <div class="form-group">
                                <p>Jumlah tenaga ahli/pakar
                                    <input type="number" name="4.5.1" class="form-control s4-inputBox s4-jumlah" placeholder="Jumlah" />
                                    orang
                                </p>
                            </div>
                            ...
                            <div class="form-group">
                                <p>Jumlah dosen yang mengikuti tugas belajar jengjang S2 pada bidang keahlian yang sesuai dengan PS dalam kurun waktu tiga tahun terakhir
                                    <input type="number" name="4.5.2s2" class="form-control s4-inputBox s4-jumlah" placeholder="Jumlah" /> orang
                                </p>
                                <p>Jumlah dosen yang mengikuti tugas belajar jenajng S3 pada bidang keahlian yang sesuai dengan PS dalam kurun waktu tiga tahun terakhir
                                    <input type="number" name="4.5.2s3" class="form-control s4-inputBox s4-jumlah" placeholder="Jumlah" /> orang
                                </p>
                            </div>
                            ...
                            <div class="form-group">
                                <p>Jumlah makalah atau kegiatan (sebagai penyaji)
                                    <input type="number" name="4.5.3a" class="form-control s4-inputBox s4-jumlah" placeholder="Jumlah" />
                                </p>
                                <p>Jumlah kehadiran (sebagai peserta)
                                    <input type="number" name="4.5.3b" class="form-control s4-inputBox s4-jumlah" placeholder="Jumlah" />
                                </p>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="radio">
                                    <label>{{ Form::radio('4.5.4', 4) }} Mendapatkan penghargaan hibah, pendanaan program dan kegiatan akademik dari institusi insternasional</label>
                                </div>
                                <div class="radio">
                            ...
                            <div class="form-group">
                                <div class="radio">
                                    <label>{{ Form::radio('4.5.5', 4) }} Lebih dari 30% dosen tetap menjadi anggota masyarakat bidang ilmu tingkat internasional</label>
                                </div>
                                <div class="radio">
                            ...
                            <div class="form-group">
                                <p>Jumlah pustakawan yang berpendidikan S2 atau S3
                                    <input type="number" name="4.6.1ax1" class="form-control s4-inputBox s4-jumlah" placeholder="Jumlah" /> orang
                                </p>
                                <p>Jumlah pustakawan yang berpendidikan D4 atau S1
                                    <input type="number" name="4.6.1ax2" class="form-control s4-inputBox s4-jumlah" placeholder="Jumlah" /> orang
                                </p>
                                <p>Jumlah pustakawan yang berpendidikan D1, D2, atau D3
                                    <input type="number" name="4.6.1ax3" class="form-control s4-inputBox s4-jumlah" placeholder="Jumlah" /> orang
                                </p>
                            </div>
                            <label>4.6.1.b &nbsp; Jumlah Laboran, teknisi, operator, <i>programmer</i></label>
                            <div class="form-group">
                                <div class="radio">
                                    <label>{{ Form::radio('4.6.2b', 4) }} Jumlah cukup dan sangat baik kegiatnnya</label>
                                </div>
                                <div class="radio">
                            ...
                            <div class="form-group">
                                <p>Jumlah tenaga administrasi yang berpendidikan D4 atau S1 ke atas
                                    <input type="number" name="4.6.1cx1" class="form-control s4-inputBox s4-jumlah" placeholder="Jumlah" /> orang
                                </p>
                                <p>Jumlah tenaga administrasi yang berpendidikan D3
                                    <input type="number" name="4.6.1cx2" class="form-control s4-inputBox s4-jumlah" placeholder="Jumlah" /> orang
                                </p>
                                <p>Jumlah tenaga administrasi yang berpendidikan D1 atau D2
                                    <input type="number" name="4.6.1cx3" class="form-control s4-inputBox s4-jumlah" placeholder="Jumlah" /> orang
                                </p>
                                <p>Jumlah tenaga administrasi yang berpendidikan SMU/SMK
                                    <input type="number" name="4.6.1cx4" class="form-control s4-inputBox s4-jumlah" placeholder="Jumlah" /> orang
                                </p>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="radio">
                                    <label>{{ Form::radio('4.6.2', 4) }} Upaya pengembangan telah dilalukan dengan sangat baik sehingga dapat meningkatkan kualifikasi dan kompetensi tenaga kependidikan</label>
                                </div>
                                <div class="radio">
